...
public class CloudGoogleComputeEnginePage extends AbstractPage {
    ...
    public void inputGPUNumber(String value){
        ...
        gpuNumberDropdown.findElement(By.xpath(String.format(template,value))).click();
    }
    ...
    public void highlightElement(WebDriver driver, WebElement element) throws IOException {
        ...
        js.executeScript(String.format(HIGHLIGHT_SCRIPT_TEMPLATE, "yellow"), element);
        makeScreenshot();
        js.executeScript(String.format(HIGHLIGHT_SCRIPT_TEMPLATE, bg), element);
    }
